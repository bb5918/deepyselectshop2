...
function Area1Page() {
    useEffect(() => {
        ...
        var imageSrc = require("../Image/marker_group2-1.png");
        var imageSrc2 = require("../Image/marker_group2-2.png");
        var imageSrc3 = require("../Image/marker_group2-3.png");
        var imageSrc4 = require("../Image/marker_group2-4.png");
